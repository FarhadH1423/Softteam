  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">SoftTeam</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('advertise.edit',2) }}"  >
          <i class="fas fa-fw fa-ad"></i>
          <span>Update Advertise</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{ route('about.edit',22) }}"  >
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('latest.index') }}"  >
          <i class="fas fa-fw fa-table"></i>
          <span>Latets News</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('contactp.index') }}"  >
          <i class="fas fa-fw fa-table"></i>
            ...
            <div class="container my-auto">
              <div class="copyright text-center my-auto">
                <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
                  <b><a href="https://farhadh.me/" target="_blank">Farhad</a></b>
                </span>
              </div>
            </div>
          </footer>
